...
export class CollectionsAccepted extends Component {
                ...
                <View style={styles.container}>
                    <Header style={styles.header}>
                        ...
                        <Body style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Title style={{color: 'white'}}>ACCEPTED</Title>
                        </Body>
                    ...
                    <List>
                        <ListItem onPress={this.goCollectionDetails}>
...
export default CollectionsAccepted;