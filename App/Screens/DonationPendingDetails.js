...
export class DonationPendingDetails extends Component {
            ...
            <Drawer
                ...
                <View style={styles.container}>
                    ...
                    <ScrollView contentContainerStyle={styles.contentContainer}>
                        ...
                        <Button block style={styles.redisterButton} onPress={this.goEditPage}>
                            <Text style={{ color: 'white', fontSize: 17 }}>Edit</Text>
                        </Button>

                        <Button block style={styles.redisterButton1} onPress={this.goCancelPage}>
...
export default DonationPendingDetails;