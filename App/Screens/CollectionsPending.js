...
export class CollectionsPending extends Component {

    openMenu() {
        this.refs.drawer.open()
    }
    goPendingDetails() {
        Actions.CollectionsPendingDetails();
    }
    goMyDonation() {
                ...
                <View style={styles.container}>
                    <Header style={styles.header}>
                        ...
                        <Body style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Title style={{color: 'white'}}>PENDING</Title>
                        </Body>
                    ...
                    <List>
                        <ListItem onPress={this.goPendingDetails}>
...
export default CollectionsPending;