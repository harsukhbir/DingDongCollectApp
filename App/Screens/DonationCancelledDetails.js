...
export class DonationCancelledDetails extends Component {
    ...
    DonationCancelledEdit() {
        Actions.DonationCancelledEdit();
    }
    goRedonate() {
                ...
                <View style={styles.container}>
                    ...
                    <ImageSlider style={styles.SliderImg} images={[
                        ...
                        <View style={styles.fbOrgaView}>
                            <Button iconRight block style={styles.dropDownView1} >
                                <Text style={styles.dropDownText1}>Organization</Text>
                                <Image style={styles.imgDropDown} source={require('../images/DropDown.png')} />
                            </Button>
                        </View>

                        <Button block style={styles.redisterButton} onPress={this.DonationCancelledEdit}>
                            <Text style={{ color: 'white', fontSize: 17 }}>Edit</Text>
                        </Button>

                        <Button block style={styles.redisterButton1} onPress={this.goRedonate}>
                            <Text style={{ color: 'white', fontSize: 17 }}>Redonate</Text>
                        </Button>
...
export default DonationCancelledDetails;