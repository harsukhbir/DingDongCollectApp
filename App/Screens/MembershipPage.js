            ...
            <Drawer
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.imgView}>
                        <View style={{ alignSelf: 'flex-start', flex: 1, marginLeft: 20 }}>
                            <TouchableOpacity>
                                <Image style={styles.imag1} source={require('../images/prime_ico_hover.png')} />
                            </TouchableOpacity>
                        </View>
                        <View style={{ alignSelf: 'flex-end', flex: 1, marginRight: 20 }}>
                            <TouchableOpacity>
                                <Image style={styles.imag2} source={require('../images/prime_ico.png')} />
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
