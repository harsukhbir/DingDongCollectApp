...
export class CollectionsFinalized extends Component {

    openMenu() {
        this.refs.drawer.open()
    }
    goCollectionDetalsFunc() {
        Actions.DonationCompletedDetails();
    }
                ...
                <View style={styles.container}>
                    <Header style={styles.header}>
                        ...
                        <Body style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Title style={{color: 'white'}}>FINALIZED</Title>
                        </Body>
                    ...
                    <List>
                        <ListItem onPress={this.goCollectionDetalsFunc}>
...
export default CollectionsFinalized;